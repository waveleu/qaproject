...
<header class="am-topbar am-topbar-inverse admin-header">
    <div class="am-topbar-brand">
        <strong><a href=<?php echo U('admin/testcase/index');?>>Amaze UI</a></strong> <small><a href=<?php echo U('admin/testcase/index');?>>后台管理模板</a></small>
    </div>
    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        ...
        <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
            <li><a href="<?php echo U('admin/testcase/add');?>" target="iframepage"><span class="am-icon-envelope-o"></span> 收件箱 <span class="am-badge am-badge-warning">5</span></a></li>
    ...
    <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar" >
            <ul class="am-list admin-sidebar-list">
                <?php if(is_array($data)): foreach($data as $key=>$v): ?><!--<?php if(empty($v['_data'])): ?>-->
                        <li><a href="<?php echo U($v['mca']);?>"><span class="am-icon-home"></span> <?php echo ($v['_name']); ?></a></li>
                    <!--<?php else: ?>
                        <li class="am-panel">
                            <a data-am-collapse="{parent: '#collapase-nav-1', target: '#{$v['name']}" href="<?php echo U($v['mca']);?>">
                                <i class="am-icon-table am-margin-left-sm"></i> <?php echo ($v['name']); ?> <i class="am-icon-angle-right am-fr am-margin-right"></i>
                            </a>
                            <ul class="am-list am-collapse admin-sidebar-sub" id=<?php echo ($v['name']); ?>>
                                <?php if(is_array($v['_data'])): foreach($v['_data'] as $key=>$n): ?><li><a href="<?php echo U($n['mca']);?>" class="am-cf"><span class="am-icon-check"></span> <?php echo ($n['name']); ?></a></li><?php endforeach; endif; ?>
                            </ul>
