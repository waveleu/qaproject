...
<div  id="content"  class="span10">
  <div  class="pageTit page-header">
    <h1>系统Version管理<?php echo ($total); ?> </h1>
    <div  class="opt">
      <a  class="btn btn-info"  href="<?php echo U('admin/OSVersion/add');?>">添加系统Version</a>
    </div>
  </div>
  ...
  <div  class="dataBox">
    ...
    <table  class="table table-bordered table-striped center">
      ...
      <tbody>
        ...
        <?php if(is_array($OS_Version_list)): foreach($OS_Version_list as $key=>$vo): ?><tr>
          <td><?php echo ($vo["OS_Version_ID"]); ?></td>
          <td><?php echo ($vo["Version"]); ?></td>
          <td><?php echo ($vo["OS_list"]); ?></td>
          <td>
            <a title="编辑" class=" btn btn-mini btn-info js_edit"     href="<?php echo U("admin/OSVersion/edit?OS_Version_ID=$vo[OS_Version_ID]");?>">编辑</a>
            <a title="删除" class=" btn btn-mini btn-danger js_del" href="<?php echo U("admin/OSVersion/del?OS_Version_ID=$vo[OS_Version_ID]");?>">删除</a>
          </td>
