...
<div class="am-cf admin-main am-padding-top-0">
 ...
 if($v['result']=='fail') echo "<td style='background-color: red'>".$v['result']."</td>"; elseif($v['result']=='pass') echo "<td style='background-color: green'>".$v['result']."</td>"; else echo "<td>".$v['result']."</td>"; ?>
                                        ...
                                        <table class="am-table-hover am-table-compact table1 line">
                                          <thead>
                                            <tr>
                                                <th class="th1"><a href="javascript:reorder('casename');">CaseName</a></th>
                                                <th class="th1"><a href="javascript:reorder('result');">Result</a></th>
                                                <th class="th1"><a href="javascript:reorder('BugID');">BugID</a></th>
                                                <th class="th1"><a href="javascript:reorder('driver');">Driver</a></th>
                                                <th class="th1"><a href="#">Status</a></th>
                                                <th class="th1"><a href="javascript:reorder('comments');">Comments</a></th>
                                                <th class="th7"><a href="#">Item</a></th>
                                                <th class="table-author am-hide-sm-only"></span>Operation</th>
                                            </tr>
                                           </thead>
                                           <tbody>
