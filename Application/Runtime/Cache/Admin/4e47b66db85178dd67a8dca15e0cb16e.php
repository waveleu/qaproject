...
<div class="admin-content">
    <div class="admin-content-body">
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">Case Origin</strong></div>
        </div>
        <div class="am-g">
            <div class="am-u-sm-12">
                <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary am-text-danger am-fr"  onclick="add()"><span class="am-icon-pencil-square-o"></span>new Case Origin</button>
...
//add new project
<div class="am-modal am-modal-confirm" tabindex="add_branch_modal" id="add_branch_modal" >
    <div class="am-modal-dialog">
        <div class="am-modal-hd">New Result Type</div>
        <div class="am-modal-bd">
            Branch<input type="text" class="am-modal-prompt-input" >
        </div>
...
<script>
    ...
    function del(obj) {
        ...
        if(confirm('Delete Case Origin？')){
            $.post("<?php echo U('Admin/FromAndResult/from_del');?>",{id:id},function (data) {
                location.reload();
            })
        }
    ...
    function add() {
        $('#add_branch_modal').modal({
            ...
            onConfirm:function (e) {
                $.post("<?php echo U('Admin/FromAndResult/from_add');?>", {name:e.data}, function (data) {
                    location.reload();
                });
            },
            onCancel:function (e) {
